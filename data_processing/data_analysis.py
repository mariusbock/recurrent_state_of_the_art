...
if __name__ == '__main__':
    print('\n RWHAR')
    rwhar_data = pd.read_csv('../data/rwhar_data.csv', header=None)
    analyze_window_lengths(rwhar_data.iloc[:, -1], rwhar_data.iloc[:, 0], 50)
    ...
    print('\n SBHAR')
    sbhar_data = pd.read_csv('../data/sbhar_data.csv', header=None)
    analyze_window_lengths(sbhar_data.iloc[:, -1], sbhar_data.iloc[:, 0], 50)

    print('\n HHAR')
    hhar_data = pd.read_csv('../data/hhar_data.csv', header=None)
    analyze_window_lengths(hhar_data.iloc[:, -1], hhar_data.iloc[:, 0], 100)

    print('\n Opportunity')
    opportunity_data = pd.read_csv('../data/opportunity_data.csv', header=None)
    analyze_window_lengths(opportunity_data.iloc[:, -1], opportunity_data.iloc[:, 0], 30)
